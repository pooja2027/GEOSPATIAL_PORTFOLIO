...
![GeoVista Dashboard](docs/screenshots/dashboard_overview.png)

*KMeans clustering of 30 Tamil Nadu AEC projects — cost heatmap + cluster markers overlay*

| Cluster Map | Cluster Summary |
|---|---|
| ![Map](docs/screenshots/cluster_map.png) | ![Summary](docs/screenshots/cluster_summary.png) |
---
